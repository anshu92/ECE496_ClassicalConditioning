package com.example.asahoo264.ece496_cc;
        ...
        import com.example.asahoo264.ble.BleDevicesScanner;
        import com.example.asahoo264.ble.BleManager;
        import com.example.asahoo264.ble.BleUtils;
        import com.example.asahoo264.ui.utils.DialogUtils;
        import com.example.asahoo264.ui.utils.ExpandableHeightExpandableListView;
...
public class WristbandActivity extends AppCompatActivity implements BleManager.BleManagerListener, BleUtils.ResetBluetoothAdapterListener {
    // Constants
    private final static String TAG = WristbandActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UartInterfaceActivity.mBleManager = BleManager.getInstance(this);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BleUtils.enableWifi(true, WristbandActivity.this);
                            WristbandActivity.super.onBackPressed();
                        }
...
//    }
    ...
    public void onClickDeviceConnect(View view) {
        ...
        if (scannedDeviceIndex < mScannedDevices.size()) {
            ...
            mBleManager.setBleListener(WristbandActivity.this);           // Force set listener (could be still checking for updates...)

            if (mSelectedDeviceData.type == BluetoothDeviceData.kType_Uart) {      // if is uart, show all the available activities

                connect(device);
                Intent intent = new Intent(WristbandActivity.this, MainActivity.class);
...
//            Log.d(TAG, "record -> lenght: " + length + " type:" + type + " data" + data);
    ...
    public void onServicesDiscovered() {
        ...
        UartInterfaceActivity.mUartService = mBleManager.getGattService(UartInterfaceActivity.UUID_SERVICE);
