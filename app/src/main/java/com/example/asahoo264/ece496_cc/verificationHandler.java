...
public class verificationHandler extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verify_handler);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.start) {
            Intent i = new Intent(verificationHandler.this, verification.class);
            if(name!=null) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == SHOW_IMAGE) {
            if (resultCode == RESULT_OK) {
                ...
                Intent i1 = new Intent(verificationHandler.this, verificationResult.class);
                if(result!=null) {
